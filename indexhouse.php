...
<body>
    ...
    if (!isset($_SESSION['account_temp']) | !isset($_SESSION['pwd_temp'])) {
        ...
        header("Refresh:1.8;url=http://localhost/New%20site/login.php");
    }
    //購物車
    ...
    <form action="" method="post">
        ...
        <div class="text-center text-white" style="padding-bottom:250px;position: relative; overflow: hidden;">
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="inde1.php">
                        <h4 style="font-size: 50px;" class="display-4 text-warning">
                ...
                <div class="col-md-6">
                    ...
                    <li class="nav-item nav-link " style="background-color:transparent;font-size:20px;font-weight:bold;border-style:none;"> 你好 <?php echo @$_SESSION['account_temp'] ?></li>
                        ...
                        <li class="nav-item"> <a href=#first style="font-size:30px; font-weight:bold;" class="nav-link text-warning">商品</a> </li>
                        ...
                        <a class="dropdown-toggle text-center" style="margin:auto;" data-toggle="dropdown" href="#">
                            <li class="oi oi-person display-5 text-warning"><span style="font-size:30px;">會員專區</li></span>
                        </a>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-10 mx-auto">
                    <p style="font-size:22px; font-weight:bold;" class="lead mb-5"> 構建這個平台讓有多出貨是用不到家具的人放上這個平台，讓租屋族可以考慮添購。 <br> 我們希望藉由此平台來，活絡整個租屋市場，讓以後租屋不是只是單一的選擇。 </p>
            ...
            <div class="container">
                <div class="row">
                    <div id="first" class="col-md-12">
						...
						<li class="nav-item"> <a href="inde.php" class="nav-link disabled"><span style="font-size:25px;">商品</span></a> </li>
                            <li class="nav-item"> <a href="#" class="active nav-link"><span style="font-size:25px;">租屋</span></a> </li>
                        </ul>
                    </div>
                </div>
                <div class="row" style="display:flex ;flex-direction: row;">
                    <?php
                    for ($j = 0; $j < $rowc; $j++) { ?>
                        <div class="col-md-4 col-lg-3 p-4"> <img class="img-fluid d-block" src="<?php echo "http://localhost:8081/New%20site" . $attr[$j][6] ?>" width="1500">
                            <h4 class="my-3"><p>地區:<b><?php echo $attr[$j][1] ?>&nbsp;</b></p> </h4>
							<p>住址:<?php echo $attr[$j][2] ?></p></b>
                            <p>月租:<?php echo $attr[$j][5] ?></p></b>
                            <p>房型:<?php echo $attr[$j][3] ?></p></b>
                            <p>電話:<?php echo $attr[$j][4] ?></p></b>
                           
                            
                            <input type="hidden" name="proid[]" value="<?php echo $attr[$j][6] ?>">
                            <input type="hidden" name="proname[]" value="<?php echo $attr[$j][1] ?>">
                            <input type="hidden" name="proimg[]" value="<?php echo "http://localhost:8081/New%20site" . $attr[$j][6] ?>">
                            <input type="hidden" name="proprice[]" value="<?php echo $attr[$j][5] ?>">
                            <input type="hidden" name="dbqty[]" value="<?php echo $attr[$j][4] ?>">
                        </div>
                    <?php } ?>
                </div>
            </div>
