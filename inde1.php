...
<body>
  ...
  if (isset($_SESSION['account_temp']) | isset($_SESSION['pwd_temp'])) {
    header("Refresh:1.8;url=http://localhost:8081/New%20site/inde.php");
}
      ...
      <div class="row" style="margin: 50px auto;">
        ...
        <div class="col-md-4 ">
          <ul class="nav nav-pills" style="margin:0">
            ...
            <li class="nav-item"> <a href=reg.php style="font-size:20px; font-weight:bold;" class="nav-link text-warning">註冊</a> </li>
            ...
            <a href="index5.php" style="font-size:20px;font-weight:bold;" class="nav-link text-warning">購物車<li class="oi oi-cart display-5 text-warning"></li></a>
          </ul>
        </div>
      </div>
